			...
			<div class="col">
				<div class="control-group control-group-inline">
					<div class="form-group floating-label-form-group controls">
						...
						<input id="txtRegisterFirstName" type="text" class="form-control" placeholder="First Name"
			...
			<div class="col">
				<div class="control-group control-group-inline">
					<div class="form-group floating-label-form-group controls">
						...
						<input id="txtRegisterLastName" type="text" class="form-control" placeholder="Last Name"
			...
			<div class="col">
				<div class="control-group">
					<div class="form-group floating-label-form-group controls">
						...
						<input id="txtRegisterEmail" type="email" class="form-control" placeholder="Email Address"
						       name="email" required/>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="control-group control-group-inline">
					<div class="form-group floating-label-form-group controls">
						...
						<input id="txtRegisterPassword1" type="password" class="form-control" placeholder="Password"
			...
			<div class="col">
				<div class="control-group control-group-inline">
					<div class="form-group floating-label-form-group controls">
						...
						<input id="txtRegisterPassword2" type="password" class="form-control"
						       placeholder="Verify Password" name="password2" required/>
					</div>
				</div>
			</div>
		</div>
